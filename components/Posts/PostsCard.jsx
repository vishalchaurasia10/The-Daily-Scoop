        ...
        <>
            <div className={`card lg:w-[${props.width || '32%'}] md:w-[47%] shadow-xl bg-[rgba(255,255,255,0.1)]  shadow-[#142c41] border border-[rgba(255,255,255,0.1)] rounded-lg md:mx-2 my-4 md:my-3 md:space-y-2`}>
                ...
                <div className="details p-4 space-y-1">
                    <h2 className='title text-3xl font-jost'>How to learn JavaScript</h2>
                    <div>
                        <span className="categories ">
                            <FontAwesomeIcon className='text-[0.5rem] pb-[0.1rem] pr-1' icon={faCircle} /><span className='font-jost text-sm cursor-pointer font-light'>Business | </span>
                        </span>
                        <span className="tags">
                            <FontAwesomeIcon className='text-sm pr-1' icon={faTags} /><span className='font-jost text-sm cursor-pointer font-light'>Tech</span>
                        </span>
                    </div>

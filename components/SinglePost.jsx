    ...
    return (
        <div className="bg-[url('/coolbg2.png')] pl-36 flex w-full">
            <div className="blogsection w-[60%]">
                ...
                <p className="blogContent text-gray-300 font-lora backdrop-blur-3xl bg-opacity-25 rounded-md shadow-xl py-3 z-50 p-3 border border-[rgba(255,255,255,0.1)] items-center">
